    ...
    def execute(
        ...
        if options:
            ...
            try:
                ...
                log.warning(
                    f"Could not parse options string '{options}': {e}. Ignoring options."
                )
        ...
        try:
            ...
            log.error(
                f"An unexpected error occurred while running tests: {e}", exc_info=True
            )
